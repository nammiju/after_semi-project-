...
import co.micol.prj.board.command.AjaxBoardInsert;
...
import co.micol.prj.book.command.AjaxBookContent;
import co.micol.prj.book.command.AjaxBookDelete;
import co.micol.prj.book.command.AjaxBookList;
import co.micol.prj.book.command.AjaxBookModal;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		map.put("/ajaxBookContent.do", new AjaxBookContent());
		
		// 게시판..
		map.put("/boardForm.do", new BoardForm()); // 게시판 페이지 열기
		map.put("/ajaxBoardList.do", new AjaxBoardList()); // 게시판 페이지에 전체 글 목록 불러오기
		map.put("/ajaxBoardInsert.do", new AjaxBoardInsert()); // 게시판 페이지에서 글 등록
		map.put("/showBoard.do", new ShowBoard()); // tr 누르면 해당 글의 상세페이지 이동
